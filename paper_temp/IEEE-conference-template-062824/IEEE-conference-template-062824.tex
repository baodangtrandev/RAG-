...
\title{T-RAG v2: An Adaptive and Latency-Optimized Selective Table Retrieval-Augmented Generation System for Multi-Source Enterprise Databases}
...
\subsubsection{Routing Threshold $\tau_{base}$ Sensitivity}
...
\subsubsection{Dynamic Threshold Coefficient $\alpha$ Sensitivity}
...
\subsubsection{Diversity Penalty $\gamma$ Sensitivity}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\linewidth]{fig_pareto.png}}
\caption{Latency vs. Correctness Trade-off and the Pareto Frontier curves.}
\label{fig:pareto}
\end{figure}

\begin{figure}[htbp]
\centerline{\includegraphics[width=0.9\linewidth]{fig_dense_sparse.png}}
...
\subsubsection{Cross-Parameter Hyperparameter Interplay: $\tau_{base}$ vs. $\gamma$}
