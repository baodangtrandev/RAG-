...
echo "=========================================="
echo "BƯỚC 1: KHỞI ĐỘNG SERVER VLLM ĐỂ CHẤM ĐIỂM (V2)"
echo "=========================================="
...
echo "=========================================="
echo "BƯỚC 2: CHẤM ĐIỂM CÁC FILE JSONL TRONG results_v2/"
echo "=========================================="

for file in results_v2/*.jsonl; do
    filename=$(basename "$file")
    eval_file="results_v2/eval_${filename%.jsonl}.json"
...
echo "=========================================="
echo "BƯỚC 3: DỌN DẸP & TỔNG HỢP V2"
echo "=========================================="
kill $VLLM_PID
echo "Đã tắt server vLLM."

echo "Đang tạo báo cáo tổng hợp..."
/network-volume/miniconda3/envs/trag/bin/python generate_report.py results_v2
