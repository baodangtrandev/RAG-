...
echo "======================================================================"
echo "PHASE 5: STARTING LOCAL JUDGE SERVER (VLLM)"
echo "======================================================================"
$PYTHON -m vllm.entrypoints.openai.api_server \
    ...
    --max-model-len 8192 \
    --port 8000 > vllm_judge_v6.2.log 2>&1 &
...
timeout 120 bash -c 'until curl -s http://localhost:8000/v1/models > /dev/null; do sleep 2; done' || {
    echo "LỖI: vLLM server không khởi động được sau 120s. Xem vllm_judge_v6.2.log."
    kill $VLLM_PID
    exit 1
}
...
echo "======================================================================"
echo "PHASE 6: EVALUATING GENERATED ANSWERS SEQUENTIALLY"
echo "======================================================================"
...
echo "======================================================================"
echo "PHASE 7: CLEANING UP & GENERATING COMPARATIVE REPORT"
echo "======================================================================"
kill $VLLM_PID
...
echo "Toàn bộ tiến trình run_all_v6.2 hoàn tất!"
