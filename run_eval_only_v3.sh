...
echo "=========================================="
echo "BƯỚC 1: KHỞI ĐỘNG SERVER VLLM ĐỂ CHẤM ĐIỂM (V3)"
echo "=========================================="
...
echo "=========================================="
echo "BƯỚC 2: CHẤM ĐIỂM CÁC FILE JSONL TRONG results_v4/"
echo "=========================================="

for file in results_v4/*.jsonl; do
    filename=$(basename "$file")
    eval_file="results_v4/eval_${filename%.jsonl}.json"
...
echo "=========================================="
echo "BƯỚC 3: DỌN DẸP & TỔNG HỢP V3"
echo "=========================================="
kill $VLLM_PID
