...
if __name__ == "__main__":
    ...
    parser.add_argument("--data-dir", type=str, default="data/EnterpriseRAG-Bench/data/documents", help="Directory containing the chunked parquet file")
    parser.add_argument("--file-name", type=str, default="test_chunked_v2.parquet", help="Filename of the chunked parquet")
    ...
    parser.add_argument("--write-batch-size", type=int, default=10000, help="Number of records to accumulate before flushing to disk")
    
    parser.add_argument("--embedding-model", type=str, default="BAAI/bge-large-en-v1.5", help="HuggingFace model ID for generating embeddings")
